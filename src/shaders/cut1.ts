...
import cut1Pass0VertexShader from './cut1/cut1_pass_0.vert.glsl?raw';
import cut1Pass0FragmentShader from './cut1/cut1_pass_0.frag.glsl?raw';

const CUT1_DEFINES = `
  #define USE_DYNAMIC_BLEND 1
  #define BLEND_MIN_CONTRAST_EDGE 0.25
...
export const CUT1_SHADERS = new Chain(
  false,
  [
  new Shader(CUT1_DEFINES + cut1Pass0VertexShader, CUT1_DEFINES + cut1Pass0FragmentShader),
  ]
)
